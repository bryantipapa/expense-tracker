                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Amount(sh)</b></label>
                                <div class="col-md-6">
                            ...
                            <fieldset class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expensecategory" id="expensecategory6" value="Insurance" <?php echo ($expensecategory == 'Insurance') ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="expensecategory6">
                                            Insurance
                                            </label>
                                        </div>
